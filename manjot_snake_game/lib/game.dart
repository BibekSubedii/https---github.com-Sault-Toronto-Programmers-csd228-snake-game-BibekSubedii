...
class _GamePageState extends State<GamePage> {
  ...
  late Piece food;
  late Offset foodPosition = Offset.zero;
...
void drawFood() {
  ...
  if (foodPosition == positions[0]) {
    ...
    foodPosition = getRandomPositionWithinRange();
  } else if (foodPosition.dx < lowerBoundX ||
             foodPosition.dx > upperBoundX ||
             foodPosition.dy < lowerBoundY ||
             foodPosition.dy > upperBoundY) {
    foodPosition = getRandomPositionWithinRange();
  }
